...
- 서울시의 교통량과 미세먼지 농도의 주중 및 주말별 상관관계를 분석했을 때, 주중은 양적 선형관계, 주말은 상관관계가 파악되지 않음  
- 이는 주중의 미세먼지 농도는 교통량의 영향이 있으며, 주말의 미세먼지 농도는 교통량의 영향이 없음을 의미함  
- 따라서 교통량이 높은 주중은 교통량이 미세먼지 농도에 영향을 주고, 교통량이 상대적으로 낮은 주말은 교통량이 미세먼지 농도에 영향을 주지 못했음을 파악 가능 ( 주말은 교통량이 낮으므로 다른 요인이 더 높게 작용했을 가능성 있음)
#### 즉, 서울시의 미세먼지 농도는 주중 및 주말별 차이가 있으며, 이 차이에는 교통량의 영향이 있음을 파악 가능  
#### 또한, 주중의 서울시 교통량-미세먼지 농도는 상관 관계가 있다는 결론을 내림 
...
#### :point_right: 최종적으로, 서울시 교통량-미세먼지 농도는 주중 및 주말의 영향을 받으며 특히 주중에서는 유의미한 선형 관계가 있음을 분석을 통해 밝혀냄
